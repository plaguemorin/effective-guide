...
public:
  ...
  explicit NoPaletteBitmap(const e00::Vec2I& size)
...
public:
  PaletteBitmap(const e00::Vec2I& size) : NoPaletteBitmap(size) {}
...
std::unique_ptr<Bitmap> Bitmap::CreateMemoryBitmap(const Vec2I& size, bool with_color_map) {
...
Bitmap::Bitmap(Vec2I size, BackingType type)
...
void Bitmap::rect(const RectI& rect, uint8_t border_color) {
  // +------+
  // |      |
  // |      |
  // +------+
...
void Bitmap::rect(const RectI& rect, uint8_t border_color, uint8_t fill_color) {
...
void Bitmap::line(const Vec2I& from, const Vec2I& to, uint8_t color) {
...
void Bitmap::blit_bitmap(const Vec2I& from, const Bitmap* source) {
...
void Bitmap::set_pixel(const Vec2I& point, const Color& color) {
